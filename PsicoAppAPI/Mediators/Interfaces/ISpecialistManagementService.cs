...
namespace PsicoAppAPI.Mediators.Interfaces
{
    public interface ISpecialistManagementService
    {
        ...
        public Task<IEnumerable<AvailabilitySlotDto>?> AddSpecialistAvailability(
        ...
        public Task<IEnumerable<AddAvailabilityDto>?> TransformToChileUTC(
            IEnumerable<AddAvailabilityDto> availabilities);
        ...
        /// </summary>
        /// <returns>IEnumerable with the Specialities</returns>
        public Task<IEnumerable<SpecialityDto>> GetAllSpecialities();
    }
}